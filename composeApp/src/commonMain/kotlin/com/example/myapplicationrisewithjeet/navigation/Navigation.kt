...
sealed class Screen {
    ...
    // Test Series flow
    data object TestSeriesCatalog : Screen()
    data object TestSeriesDetail : Screen()
    data object TestSeriesCheckout : Screen()
    data object TestSeriesDashboard : Screen()
    data object TestSeriesReady : Screen()
    data object TestSeriesQuestion : Screen()
    data object TestSeriesResult : Screen()
    data object TestSeriesReport : Screen()
    data object TestSeriesIntelligence : Screen()
